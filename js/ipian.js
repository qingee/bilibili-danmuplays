var lele = {
		...
		'start':function(){
		$.ajax({
			url: "https://danmu.ipian.net/admin/api.php",
            dataType: "json",
			success: function (e) {
...
//		    alert("timeupdate");
	...
	'MYad':{
		...
		'pause':{
			...
			var pause_ad_html = '<div id="player_pause"><div class="tip"><a style="color:#ffffff;cursor:pointer;"  onclick="javascript:turnoff('+"'player_pause'"+')">关闭</a></div><a href="'+l+'" target="_blank" ><img src="'+p+'"></a></div>';
